...
!(function(window, document, $) {
  ...
  ($.app.menu = {
    ...
    change: function() {
      ...
      ("vertical-menu" !== menuType &&
        ...
        "horizontal-menu" != menuType &&
          "horizontal-top-icon-menu" != menuType &&
        ...
        ("horizontal-menu" != menuType &&
          ...
          ("sm" == currentBreakpoint.name || "xs" == currentBreakpoint.name
            ...
            : $(".navbar-fixed").length && $(".navbar-fixed").sticky()),
        ("vertical-menu" !== menuType &&
          "vertical-overlay-menu" !== menuType &&
          "vertical-content-menu" !== menuType) ||
    ...
    transit: function(callback1, callback2) {
      ...
      $body.addClass("changing-menu"),
        ...
        $body.hasClass("vertical-layout") &&
          ($body.hasClass("menu-open") || $body.hasClass("menu-expanded")
            ? ($(".menu-toggle").addClass("is-active"),
              ("vertical-menu" !== $body.data("menu") &&
                "vertical-content-menu" !== $body.data("menu")) ||
                ($(".main-menu-header") && $(".main-menu-header").show()))
            : ($(".menu-toggle").removeClass("is-active"),
              ("vertical-menu" !== $body.data("menu") &&
                "vertical-content-menu" !== $body.data("menu")) ||
                ($(".main-menu-header") && $(".main-menu-header").hide()))),
        setTimeout(function() {
    ...
    open: function() {
      $body.is(".vertical-mmenu") && this.mMenu.enable(),
        this.transit(
          function() {
    ...
    hide: function() {
      $body.is(".vertical-mmenu") && this.mMenu.disable(),
        this.transit(
          function() {
    ...
    expand: function() {
      this.expanded === !1 &&
        ("vertical-menu" == $body.data("menu") && this.changeLogo("expand"),
        this.transit(
          function() {
          ...
          function() {
            $body.is(".vertical-mmenu")
              ? this.mMenu.enable()
              : $(".main-menu").hasClass("menu-native-scroll") ||
                "vertical-mmenu" == $body.data("menu") ||
                "horizontal-menu" == $body.data("menu") ||
                "horizontal-top-icon-menu" == $body.data("menu")
    ...
    collapse: function() {
      this.collapsed === !1 &&
        ("vertical-menu" == $body.data("menu") && this.changeLogo("collapse"),
        this.transit(
          function() {
    ...
    changeMenu: function(screen) {
      ...
      var menuWrapper = $('div[data-menu="menu-wrapper"]'),
        menuNavigation = ($('div[data-menu="menu-container"]'),
    ...
    ($.app.nav = {
      ...
      init: function(config) {
        (this.initialized = !0),
          ...
          $body.is(".vertical-mmenu") || this.bind_events();
      },
        ...
        $(".navigation-main")
          .on("mouseenter.app.menu", "li", function() {
            ...
            if (
              ...
              var tempTitle,
                tempLink,
                menuTitle = $this.find("span.menu-title").clone();
              ...
              if (
                ...
                "vertical-compact-menu" !== $body.data("menu") &&
                  menuTitle
                    ...
                    .css({ position: "fixed", top: fromTop }),
          ...
          $("ul.menu-content").on("click", "li", function(e) {
            ...
            if ($listItem.is(".disabled")) e.preventDefault();
              ...
              if ($listItem.is(".open"))
                $listItem.removeClass("open"), menuObj.collapse($listItem);
              else {
                if (
                  ($listItem.addClass("open"),
                  menuObj.expand($listItem),
